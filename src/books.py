...
BOOKS = {
    ...
    'numbers':       {'display': 'Numbers',         'bhsa': 'Numbers',        'chapters': 36, 'order': 4,  'sense_code': 'numbers'},
    'deuteronomy':   {'display': 'Deuteronomy',     'bhsa': 'Deuteronomy', 'chapters': 34, 'order': 5,  'sense_code': 'deuteronomy'},
    'joshua':        {'display': 'Joshua',          'bhsa': 'Joshua',         'chapters': 24, 'order': 6,  'sense_code': 'joshua'},
    'judges':        {'display': 'Judges',          'bhsa': 'Judges',       'chapters': 21, 'order': 7,  'sense_code': 'judges'},
    '1samuel':       {'display': '1 Samuel',        'bhsa': '1_Samuel',      'chapters': 31, 'order': 8,  'sense_code': '1samuel'},
    '2samuel':       {'display': '2 Samuel',        'bhsa': '2_Samuel',     'chapters': 24, 'order': 9,  'sense_code': '2samuel'},
    '1kings':        {'display': '1 Kings',         'bhsa': '1_Kings',       'chapters': 22, 'order': 10, 'sense_code': '1kings'},
    '2kings':        {'display': '2 Kings',         'bhsa': '2_Kings',      'chapters': 25, 'order': 11, 'sense_code': '2kings'},
    'isaiah':        {'display': 'Isaiah',          'bhsa': 'Isaiah',        'chapters': 66, 'order': 12, 'sense_code': 'isaiah'},
    'jeremiah':      {'display': 'Jeremiah',        'bhsa': 'Jeremiah',       'chapters': 52, 'order': 13, 'sense_code': 'jeremiah'},
    'ezekiel':       {'display': 'Ezekiel',         'bhsa': 'Ezekiel',      'chapters': 48, 'order': 14, 'sense_code': 'ezekiel'},
    ...
    'obadiah':       {'display': 'Obadiah',         'bhsa': 'Obadiah',        'chapters': 1,  'order': 18, 'sense_code': 'obadiah'},
    'jonah':         {'display': 'Jonah',           'bhsa': 'Jonah',          'chapters': 4,  'order': 19, 'sense_code': 'jonah'},
    'micah':         {'display': 'Micah',           'bhsa': 'Micah',         'chapters': 7,  'order': 20, 'sense_code': 'micah'},
    'nahum':         {'display': 'Nahum',           'bhsa': 'Nahum',         'chapters': 3,  'order': 21, 'sense_code': 'nahum'},
    'habakkuk':      {'display': 'Habakkuk',        'bhsa': 'Habakkuk',       'chapters': 3,  'order': 22, 'sense_code': 'habakkuk'},
    'zephaniah':     {'display': 'Zephaniah',       'bhsa': 'Zephaniah',      'chapters': 3,  'order': 23, 'sense_code': 'zephaniah'},
    'haggai':        {'display': 'Haggai',          'bhsa': 'Haggai',        'chapters': 2,  'order': 24, 'sense_code': 'haggai'},
    'zechariah':     {'display': 'Zechariah',       'bhsa': 'Zechariah',      'chapters': 14, 'order': 25, 'sense_code': 'zechariah'},
    'malachi':       {'display': 'Malachi',         'bhsa': 'Malachi',      'chapters': 3,  'order': 26, 'sense_code': 'malachi'},
    'psalms':        {'display': 'Psalms',          'bhsa': 'Psalms',        'chapters': 150,'order': 27, 'sense_code': 'psalms'},
    'job':           {'display': 'Job',             'bhsa': 'Job',           'chapters': 42, 'order': 28, 'sense_code': 'job'},
    'proverbs':      {'display': 'Proverbs',        'bhsa': 'Proverbs',     'chapters': 31, 'order': 29, 'sense_code': 'proverbs'},
    'ruth':          {'display': 'Ruth',            'bhsa': 'Ruth',          'chapters': 4,  'order': 30, 'sense_code': 'ruth'},
    'songofsongs':   {'display': 'Song of Songs',   'bhsa': 'Song_of_songs',      'chapters': 8,  'order': 31, 'sense_code': 'songofsongs'},
    'ecclesiastes':  {'display': 'Ecclesiastes',    'bhsa': 'Ecclesiastes',  'chapters': 12, 'order': 32, 'sense_code': 'ecclesiastes'},
    'lamentations':  {'display': 'Lamentations',    'bhsa': 'Lamentations',        'chapters': 5,  'order': 33, 'sense_code': 'lamentations'},
    ...
    'daniel':        {'display': 'Daniel',          'bhsa': 'Daniel',        'chapters': 12, 'order': 35, 'sense_code': 'daniel',
                      'aramaic': [(2, 7)]},
    'ezra':          {'display': 'Ezra',            'bhsa': 'Ezra',          'chapters': 10, 'order': 36, 'sense_code': 'ezra',
                      'aramaic': [(4, 7)]},
    'nehemiah':      {'display': 'Nehemiah',        'bhsa': 'Nehemiah',       'chapters': 13, 'order': 37, 'sense_code': 'nehemiah'},
    '1chronicles':   {'display': '1 Chronicles',    'bhsa': '1_Chronicles',    'chapters': 29, 'order': 38, 'sense_code': '1chronicles'},
    '2chronicles':   {'display': '2 Chronicles',    'bhsa': '2_Chronicles',   'chapters': 36, 'order': 39, 'sense_code': '2chronicles'},
}
